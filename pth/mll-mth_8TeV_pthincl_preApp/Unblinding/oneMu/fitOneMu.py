...
command = "combine --saveWorkspace -M MultiDimFit datacards/hww-19.47fb.mH125.of_pthincl_shape_workspace.root --algo=singles --saveToys&> logFull.txt"
os.popen(command)

command = "combine --saveWorkspace -M MultiDimFit datacards/hww-19.47fb.mH125.of_pthincl_shape_workspace.root --algo=singles --freezeNuisances="+",".join(correlated)+"&>logStatOnly.txt"
os.popen(command)
